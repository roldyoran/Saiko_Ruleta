...
var spinTime = 0;
var spinTimeTotal = 0;
var spinAngleStart; // AGREGADO SE PUEDE BORRAR
var ctx;
...
function spin() {
  ...
  rightImage.src = "TaniaColegialastick2.webp";
  setTimeout(function () {
    rightImage.src = "TaniaColegialastick1.webp";
  }, 350); // Ajusta el tiempo según sea necesario (en milisegundos)

  // Genera un número aleatorio entre 1 y 9 (ambos inclusive)
  var nmajah = Math.floor(Math.random() * (12 - 2 + 1)) + 8;
