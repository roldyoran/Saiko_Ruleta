...
function playMusic() {
  ...
  const audioFiles = ["Isekai_Isekai.mp3", "saikomicarts.mp3", "Saikomic_en_la_Zona.mp3", "Tomboygod.mp3"]; // "op_random2.mp3", "anime_fin.mp3", "trap_fin.mp3", "rock_fin.mp3", "yugi_op.mp3", "anime_fin.mp3", "trap_fin.mp3", "saiko_qlao.mp3", "Tomboygod.mp3", "diatranquilo.mp3", "gustos.mp3", 
